...
async function profileGet(req, res, next) {
  try {
    ...
    res.render("courier/profile", { title: "Perfil", user });
  } catch (err) {
    next(err);
  }
}
...
module.exports = { dashboard, available, accept, pickedUp, delivered, cancel, history, reviews, profileGet, profilePost };
